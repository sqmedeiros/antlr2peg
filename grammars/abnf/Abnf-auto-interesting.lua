...
local files = {
    "interestingInput/test_2878153605691131279435791100517606654-fixed.abnf",
    "interestingInput/test_2878153605691131279435791100517606654-small-fixed.abnf",
}
Util.testFiles(files, p)


local files = {
    "interestingInput/test_2878153605691131279435791100517606654.abnf",
    "interestingInput/test_2878153605691131279435791100517606654-small.abnf",
}
