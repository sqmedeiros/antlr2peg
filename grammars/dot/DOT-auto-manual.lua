...
EDGE            <-  [Ee] [Dd] [Gg] [Ee]
SUBGRAPH        <-  [Ss] [Uu] [Bb] [Gg] [Rr] [Aa] [Pp] [Hh]
NUMBER          <-  !(STRICT / GRAPH / DIGRAPH / NODE / EDGE / SUBGRAPH) '-'? ('.' DIGIT+  /  DIGIT+ ('.' DIGIT*)?)
DIGIT           <-  [0-9]
STRING          <-  !(STRICT / GRAPH / DIGRAPH / NODE / EDGE / SUBGRAPH / NUMBER) '"' (!'"' ('\\"'  /  .))* '"'
ID              <-  !(STRICT / GRAPH / DIGRAPH / NODE / EDGE / SUBGRAPH / STRING) LETTER (LETTER  /  DIGIT)*
LETTER          <-  [a-zA-Z_]
HTML_STRING     <-  '<' (TAG  /  ![<>] .)* '>'
TAG             <-  '<' (!'>' .)* '>'
COMMENT         <-  '/*' (!'*/' .)* '*/'
