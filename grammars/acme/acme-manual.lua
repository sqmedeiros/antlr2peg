...
acmeRepresentationDeclaration   <-   REPRESENTATION (IDENTIFIER ASSIGN )? LBRACE acmeSystemDeclaration (acmeBindingsMapDeclaration )? RBRACE (SEMICOLON )? 
...
acmePropertyRecord   <-   LBRACKET (acmePropertyRecordEntry (SEMICOLON acmePropertyRecordEntry )* (SEMICOLON )? )? RBRACKET 
...
dRRelationalExpression   <-   dRAdditiveExpression ((LANGLE dRAdditiveExpression )   /  (RANGLE dRAdditiveExpression )   /  (LE dRAdditiveExpression )   /  (GE dRAdditiveExpression ) )* 
dRAdditiveExpression   <-   dRMultiplicativeExpression ((PLUS dRMultiplicativeExpression )   /  (MINUS dRMultiplicativeExpression ) )* 
dRMultiplicativeExpression   <-   dRNegativeExpression ((STAR dRNegativeExpression )   /  (SLASH dRNegativeExpression )   /  (REM dRNegativeExpression )   /  (POWER dRNegativeExpression ) )* 
...
pathExpression   <-   (SLASH reference ((COLON   /  SET_DECLARE ) acmeTypeRef )? (LBRACKET designRuleExpression RBRACKET )? (SLASH pathExpressionContinuation )* ) 
...
literalRecord   <-   LBRACKET (literalRecordEntry (SEMICOLON literalRecordEntry )* (SEMICOLON )? )? RBRACKET 
